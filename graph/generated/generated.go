...
func (ec *executionContext) _Programmer_skills(ctx context.Context, field graphql.CollectedField, obj *model.Programmer) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNSkill2ᚕᚖgraphqlᚑexampleᚋgraphᚋmodelᚐSkillᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_programmers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProgrammer2ᚕᚖgraphqlᚑexampleᚋgraphᚋmodelᚐProgrammerᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNProgrammer2ᚕᚖgraphqlᚑexampleᚋgraphᚋmodelᚐProgrammerᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Programmer) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProgrammer2ᚖgraphqlᚑexampleᚋgraphᚋmodelᚐProgrammer(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProgrammer2ᚖgraphqlᚑexampleᚋgraphᚋmodelᚐProgrammer(ctx context.Context, sel ast.SelectionSet, v *model.Programmer) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNSkill2ᚕᚖgraphqlᚑexampleᚋgraphᚋmodelᚐSkillᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Skill) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNSkill2ᚖgraphqlᚑexampleᚋgraphᚋmodelᚐSkill(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNSkill2ᚖgraphqlᚑexampleᚋgraphᚋmodelᚐSkill(ctx context.Context, sel ast.SelectionSet, v *model.Skill) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
